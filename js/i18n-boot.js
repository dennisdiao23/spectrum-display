...
(function () {
  ...
  css.textContent =
    ...
    '@media (max-width:767px){:root{--site-header-h:calc(4.5rem + 10px);--site-tabbar-h:calc(6.5rem - 20px + env(safe-area-inset-bottom,0px))}body{padding-bottom:var(--site-tabbar-h)}}' +
