...
function normalizeCustomer(input) {
  ...
  return {
    ...
    salesRepId: trim(src.salesRepId != null ? src.salesRepId : src.sales_rep_id, 40),
    salesRep: trim(src.salesRep || src.sales_rep, 120),
    customerType: trim(src.customerType || src.customer_type, 80),
...
function formatCustomer(row) {
  ...
  return {
    ...
    salesRepId: row.sales_rep_id == null || row.sales_rep_id === '' ? '' : String(row.sales_rep_id),
