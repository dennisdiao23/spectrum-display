...
function normalizeDoc(input) {
  ...
  return {
    ...
    soNumber: trim(src.soNumber || src.so_number, 80),
    rep: trim(src.rep, 80),
    accountNo: trim(src.accountNo || src.account_no || src.account, 80),
    shipDate: trim(src.shipDate || src.ship_date, 20),
    shipVia: trim(src.shipVia || src.ship_via, 80),
    tracking: trim(src.tracking, 80),
